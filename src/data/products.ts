...
export const PRODUCTS: Product[] = [
  {
    ...
    tags: ['beginner','intermediate','all_weather','all_season','waterproof','goretex','high_grip','trail_shoes_beginner','trail_shoes_intermediate','waterproof_shoes'],
    isFeatured: true,
  ...
  },
  {
    ...
    tags: ['intermediate','advanced','sunny','cloudy','spring','summer','autumn','trail_shoes_intermediate','trail_shoes_advanced','high_grip','lightweight'],
    isFeatured: true,
    stockStatus: 'in_stock',
  },
  {
    ...
    tags: ['beginner','intermediate','advanced','rainy','all_season','waterproof','lightweight','rain_jacket'],
    isFeatured: true,
    stockStatus: 'in_stock',
  },
  {
    ...
    tags: ['intermediate','sunny','cloudy','spring','summer','autumn','trail_shoes_intermediate','lightweight','cushioning'],
    isFeatured: false,
    stockStatus: 'in_stock',
  },
  {
    ...
    tags: ['beginner','intermediate','advanced','cloudy','rainy','all_season','waterproof','breathable','windshell','rain_jacket'],
    isFeatured: true,
    stockStatus: 'in_stock',
  },
  {
    ...
    tags: ['intermediate','advanced','cloudy','rainy','snowy','winter','waterproof','windshell','rain_jacket'],
    isFeatured: false,
    stockStatus: 'in_stock',
  },
  {
    ...
    tags: ['beginner','intermediate','advanced','sunny','all_season','lightweight','breathable','hat'],
    isFeatured: false,
    stockStatus: 'in_stock',
  },
  {
    ...
    tags: ['intermediate','advanced','all_weather','all_season','trekking_poles'],
    isFeatured: false,
    stockStatus: 'in_stock',
  },
];
...
export function getRecommendedProducts(
  ...
  const scored = PRODUCTS
    ...
    .map(p => {
      ...
      return { product: p, score: p.tags.includes(userLevel) ? score : -1 };
    })
    .filter(s => s.score > 0)
